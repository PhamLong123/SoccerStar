...
<footer class="text-center text-lg-start bg-dark text-white">
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col col-md-3 text-center col-lg-2 col-xl-3 mx-auto mb-4">
                    ...
                    <p>
                        <a href="{{ Route('customer.home') }}" class="text-reset">Trang chủ</a>
                    </p>
                    <p>
                        <a href="{{ Route('user.product') }}" class="text-reset">Sản phẩm</a>
                    </p>
                    <p>
                        <a href="{{ route('user.size') }}" class="text-reset">Hướng dẫn</a>
                    </p>
                    <p>
                        <a href="{{ Route('customer.contact') }}" class="text-reset">Liên hệ</a>
                    </p>
                    <p>
                        <a href="{{ route('user.news') }}" class="text-reset">Tin tức</a>
                    </p>
                </div>
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <!-- Right -->
        <div>
            <a class="btn btn-outline-light btn-floating m-1 " target="_blank" href="https://www.google.com.vn/?hl=vi" role="button"><i class="fab fa-google"></i></a>
            <!-- Google -->
            <a class="btn btn-outline-light btn-floating m-1" target="_blank" href="https://www.facebook.com/100035544995231/" role="button"><i class="fab fa-facebook-f"></i></a>
            <!-- Instagram -->
            ...
            <!-- Github -->
            <a class="btn btn-outline-light btn-floating m-1" target="_blank" href="https://github.com/QuanLe0702" role="button"><i class="fab fa-github"></i></a>
        </div>
        <!-- Right -->
    </section>
    <!-- Section: Social media -->
